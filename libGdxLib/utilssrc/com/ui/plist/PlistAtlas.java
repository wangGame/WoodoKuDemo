...
public class PlistAtlas implements Disposable {
	...
	private void load (PlistAtlasData data) {
		ObjectMap<PlistAtlasData.Page, Texture> pageToTexture = new ObjectMap<PlistAtlasData.Page, Texture>();
		for (PlistAtlasData.Page page : data.pages) {
		...
		for (PlistAtlasData.Region region : data.regions) {
