...
public class MClickListener extends InputListener {
    /**
    ...
    private float tapSquareSize = 20, touchDownX = -1, touchDownY = -1;
     ...
     * @see #setButton(int)
     */
    public MClickListener(int button) {
        this.button = button;
    }
